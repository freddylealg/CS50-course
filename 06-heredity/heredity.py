...
def normalize(probabilities):
    ...
    for person in probabilities.keys():
        max_value = 0
        max_value += probabilities[person]['gene'][2]
        max_value += probabilities[person]['gene'][1]
        max_value += probabilities[person]['gene'][0]

        probabilities[person]['gene'][2] = probabilities[person]['gene'][2] / max_value
        probabilities[person]['gene'][1] = probabilities[person]['gene'][1] / max_value
        probabilities[person]['gene'][0] = probabilities[person]['gene'][0] / max_value

        max_value = probabilities[person]['trait'][True] + probabilities[person]['trait'][False]
        probabilities[person]['trait'][True] = probabilities[person]['trait'][True] / max_value
        probabilities[person]['trait'][False] = probabilities[person]['trait'][False] / max_value
